...
export NAMESPACE="Fake_Staat_der_Nederlanden_Organisatie_Persoon_CA"
...
SUBJECT="/C=NL/O=Fake Staat der Nederlanden/CN=Fake Staat der Nederlanden Organisatie Persoon CA - G42"
echo "CSR Generating..."
generate_csr_file
