...
export I_NAMESPACE="UZI-register_Medewerker_niet_op_naam_CA_G3"
...
SUBJECT="/C=NL/O=${ORG:-CIBG}/OU=${OU:-Random Department}/serialNumber=${SERIAL:-1337}/CN=${FUNCTION_NAME:-Zorg Medewerker}"
echo "CSR Generating..."
generate_csr_file
